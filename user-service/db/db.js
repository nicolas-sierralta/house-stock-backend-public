/**
 * @fileoverview This file sets up the Sequelize connection to the MySQL database for the user service.
 * It includes retry logic for connecting to the database in case of failure.
 * @namespace db
